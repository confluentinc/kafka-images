...
public class sslKafkaIT {
    ...
    public void setup() {
      ...
      //  Thread.sleep(3600000);
        ...
        System.out.println(getClass().getResource("/client-creds/kafka.client.truststore.pkcs12").getFile());
        System.out.println(getClass().getResource("/client-creds/kafka.client.truststore.pkcs12").getPath());
        props.put("ssl.keystore.type", "PKCS12");
        props.put(AdminClientConfig.SECURITY_PROTOCOL_CONFIG, "SSL");
        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG,getClass().getResource("/client-creds/kafka.client.truststore.pkcs12").getFile());
        props.put(SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG, "confluent");
        props.put(SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG, getClass().getResource("/client-creds/kafka.client.keystore.pkcs12").getFile());
